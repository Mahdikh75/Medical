...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.StepCounterNotiCm, Medical", StepCounterNotiCm.class, __md_methods);
	}


	public StepCounterNotiCm ()
	{
		super ();
		if (getClass () == StepCounterNotiCm.class)
			mono.android.TypeManager.Activate ("Medical.StepCounterNotiCm, Medical", "", this, new java.lang.Object[] {  });
	}
