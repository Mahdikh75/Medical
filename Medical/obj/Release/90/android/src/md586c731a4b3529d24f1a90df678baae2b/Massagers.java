...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.Massagers, Medical", Massagers.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Massagers.class)
			mono.android.TypeManager.Activate ("Medical.Massagers, Medical", "", this, new java.lang.Object[] {  });
	}
