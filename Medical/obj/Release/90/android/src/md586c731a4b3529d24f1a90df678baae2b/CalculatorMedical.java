...
public class CalculatorMedical
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.CalculatorMedical, Medical", CalculatorMedical.class, __md_methods);
	}


	public CalculatorMedical ()
	{
		super ();
		if (getClass () == CalculatorMedical.class)
			mono.android.TypeManager.Activate ("Medical.CalculatorMedical, Medical", "", this, new java.lang.Object[] {  });
	}
