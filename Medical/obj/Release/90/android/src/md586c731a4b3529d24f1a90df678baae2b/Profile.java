...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.Profile, Medical", Profile.class, __md_methods);
	}
	...
	public Profile ()
	{
		...
		if (getClass () == Profile.class)
			mono.android.TypeManager.Activate ("Medical.Profile, Medical", "", this, new java.lang.Object[] {  });
	}
