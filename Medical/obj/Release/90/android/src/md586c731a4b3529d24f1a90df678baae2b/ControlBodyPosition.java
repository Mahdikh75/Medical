...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.ControlBodyPosition, Medical", ControlBodyPosition.class, __md_methods);
	}


	public ControlBodyPosition ()
	{
		super ();
		if (getClass () == ControlBodyPosition.class)
			mono.android.TypeManager.Activate ("Medical.ControlBodyPosition, Medical", "", this, new java.lang.Object[] {  });
	}
