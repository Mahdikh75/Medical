...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Medical.Amain, Medical", Amain.class, __md_methods);
	}
	...
	public Amain ()
	{
		...
		if (getClass () == Amain.class)
			mono.android.TypeManager.Activate ("Medical.Amain, Medical", "", this, new java.lang.Object[] {  });
	}
